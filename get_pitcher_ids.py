import csv
import os
from pybaseball import team_pitching_bref, playerid_lookup
...
for year in year_list:
    ...
    names_list = []  # Reset the names_list for each year
    for team in mlb_teams:
        data = team_pitching_bref(team, year)
    ...
    with open(f'{directory}/pitcher_ids.csv', 'w', newline='') as csvfile:
